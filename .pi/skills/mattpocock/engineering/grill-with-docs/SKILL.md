...
During codebase exploration, consume domain docs using [../references/DOMAIN_DOCS.md](../references/DOMAIN_DOCS.md). This skill is a producer flow: create or update domain docs lazily when language or decisions crystallize.
