...
Consume domain docs using [../references/DOMAIN_DOCS.md](../references/DOMAIN_DOCS.md): read the project's domain glossary and any ADRs in the area you're touching first.
